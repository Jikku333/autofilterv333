...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if (clicked == typed):
        ...
        if query.data.startswith("next"):
            ...
            buttons = [
                [
                    InlineKeyboardButton('❌OUR CHANNEL❌', url='https://t.me/RHYTHMHACKER')
                ]
                ]
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        InlineKeyboardButton('⭕OUR GROUP⭕', url='https://t.me/RHYTHMHACKER')
                    ]
                    ]
        ...
        await query.answer("ഇത്‌ നിങ്ങൾക്കുള്ളതല്ല 😉 നിങ്ങൾക്ക് വേണ്ട സിനിമ request ചെയൂ 😗",show_alert=True)
